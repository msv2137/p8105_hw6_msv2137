...
```
This model selection approach starts with all predictors in the model. It then removes the the next least significant predictor. It repeats this process until all non-significant predictors have been removed.
...
```
The plot is centered around .91, 
